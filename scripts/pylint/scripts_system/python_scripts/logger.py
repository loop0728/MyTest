...
class Logger:
    ...
    def print_info(self, message: MessageType, task_name: str = None):
        """
        info日志
        :param message: 信息
        :param task_name: 任务名称
    ...
    def print_warning(self, message: MessageType, task_name: str = None):
        """
        warning日志
        :param message: 信息
        :param task_name: 任务名称
    ...
    def print_error(self, message: MessageType, task_name: str = None):
        """
        error日志
        :param message: 信息
        :param task_name: 任务名称
