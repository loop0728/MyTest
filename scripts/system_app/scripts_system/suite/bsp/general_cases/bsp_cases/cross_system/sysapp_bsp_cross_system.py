...
class SysappBspCrossSystem(SysappCaseBase, SysappBspGeneralCaseBase):
    ...
    def runcase(self):
        ...
        """
        args = {}
        ret_test = self.run_mid_func("cross_system", args)
    ...
    def system_help():
        ...
        Returns:
            None
        """
        logger.warning("Test the use of BSP modules cross systems")
