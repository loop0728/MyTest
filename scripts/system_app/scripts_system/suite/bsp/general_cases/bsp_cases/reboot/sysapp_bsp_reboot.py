...
class SysappBspReboot(SysappCaseBase, SysappBspGeneralCaseBase):
    ...
    def system_help():
        ...
        Returns:
            None
        """
        logger.warning("Test the reboot of the bsp module")
