...
class SysappBspHotplug(SysappCaseBase, SysappBspGeneralCaseBase):
    """A class representing  hotplug test flow
    Attributes:
    ...
    def runcase(self):
        ...
        """
        args = {"test":1}
        self.run_mid_func("hotplug", args)
    ...
    def system_help():
        ...
        Returns:
            None
        """
        logger.warning("Test the hotplug of the bsp module")
