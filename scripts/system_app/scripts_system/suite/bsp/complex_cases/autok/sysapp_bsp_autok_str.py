...
class SysappBspAutokStr(CaseBase):
    """Autok And Ott Nomal Boot Flow Case

    Test Info
    1.In the STR scenario, check whether autok is run after Reusme
    ...
    def system_help():
        ...
        Returns:
            None
        """
        logger.warning("In the STR scenario, check whether autok is run after Reusme")
