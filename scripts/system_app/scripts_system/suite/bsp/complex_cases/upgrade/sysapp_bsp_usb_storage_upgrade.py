...
class SysappBspUsbStorageUpgrade(SysappCaseBase):
    """Case for USB Storage Upgrade ."""
    ...
    def runcase(self):
        ...
        logger.info("Testing USB Storage Uprade case.")
        ...
        if self.notice_prepare_hw():
            ...
            #usbstar upgrade，after in uboot?
            ret = self.start_usb_storage_upgrade()
            if ret is False:
                logger.error(f"{self.uart} start_usb_storage_upgrade err!")
            ...
            if ret is False:
                logger.error(f"{self.uart} After usbstar and change bootstrap ,\
        ...
        logger.info("Testing USB Storage Uprade case finish!")
    ...
    def system_help():
        ...
        Returns:
            None
        """
        logger.warning("Test for USB Storage Upgrade(usbstar command) Normal Image.")
