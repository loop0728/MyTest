...
"""cold kernel mode2 test scenarios"""
...
class SysappSysKernelRebootMode2(RebootCase):
    ...
    def check_board_ping(self)-> int:
        ...
        Returns:
            int: result
        """
        logger.warning("go to check_board_ping!\n")
    ...
    def runcase_help():
        ...
        logger.warning("general case runcmd:  python sysapp_run_user_case.py \
                       suite/sys/reboot/sysapp_sys_kernel_reboot_mode2.py reboot_mode2 1\n")
        logger.warning("support stress! eg cmd:kernel_reboot_mode2_stress_5\n")
        logger.warning("stress  case runcmd: python sysapp_run_user_case.py \
                       suite/sys/reboot/sysapp_sys_kernel_reboot_mode2.py \
                       kernel_reboot_mode2_stress_5 1\n")
