...
str_l2l_target = server_get_platform_extract_value("PLATFORM_STR_L2L")
str_h2l_target = server_get_platform_extract_value("PLATFORM_STR_H2L")
...
uboot_prompt = server_get_platform_extract_value("PLATFORM_UBOOT_PROMPT")
kernel_prompt = server_get_platform_extract_value("PLATFORM_KERNEL_PROMPT")
