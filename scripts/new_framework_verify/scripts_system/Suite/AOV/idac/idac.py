...
import Suite.AOV.idac.reboot_opts as reboot_opts
...
class idac(CaseBase):
    ...
    def get_kernel_idac_info(self):
        result = 255
        local_path = f"{platform.local_mount_path}/{self.mount_path}"
        dts_path = f"{local_path}/{self.dump_dts_name}"
    ...
    def idac_test(self):
        ...
        # mount server path to the board
