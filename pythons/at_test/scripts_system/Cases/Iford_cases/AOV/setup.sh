...
AddCaseSystem 0x01 /Suite/AOV/str_crc "Suite/AOV/str_crc/str_crc.py" str_crc on
...
AddCaseSystem 0x10 /Suite/AOV/stress_case "Suite/AOV/str_crc/str_crc.py" str_crc_stress_3 on
AddCaseSystem 0x01 /Suite/AOV/template "Suite/AOV/template/template.py" template on
############################## os_switch ##############################
